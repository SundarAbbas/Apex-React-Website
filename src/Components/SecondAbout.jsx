  ...
  return (
    <div>
      <div className="p-3 gap-3 items-center justify-center grid grid-cols-1  lg:grid-cols-2 max-w-6xl mx-auto min-h-[500px] ">
        <div className="w-full flex items-center justify-center sm:min-h-[400px]">
          <img src="/secondAbout.png" className="h-[400px]" alt="" />
        </div>
        <div className="p-10 lg:px-0 text-center lg:text-justify ">
          <h1 className="mb-5 text-gray-600 font-semibold lg:text-4xl text-[21px] ">
          ...
          <p className="text-gray-600 mb-5 text-justify ">
            ...
            Ullam vitae corrupti placeat? Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci tenetur nobis voluptatibus dignissimos dolor provident porro enim earum pariatur.
          </p>
